...
(function($) {
    $.fn.filestyle = function(options) {
        ...
        return this.each(function() {
			...
			var wrapper = $('<div id="upload_button_'+self.id+'" class="upload button secondary_btn"> <span class="upload_title"><i class="fa fa-folder"></i> '+upload_single_title+'</span>').css({"display": "inline","position": "relative","overflow": "hidden"});
...
jQuery(function(){
  ...
  var $container = jQuery('.submit_form_custom_fields'),
      $checkboxes = jQuery('form#submit_form .category_label input');

  $container.isotope({
    itemSelector: '.custom_fileds'
  });
  ...
  $checkboxes.change(function(){
    ...
    $checkboxes.filter(':checked').each(function(){
      ...
      filters.push( jQuery(this).attr('data-class'));
	  filters.push( jQuery(this).attr('data-all'));
    });
    // ['.red', '.blue'] -> '.red, .blue'
