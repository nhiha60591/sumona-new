     ...
     <body style="padding:40px;">
		...
		?>
          ...
          <?php else:								
				 ...
				 echo '<p><b>'.__('Important!',ADMINDOMAIN).'</b> '.__('Clicking on "Update Now" will overwrite all files. If you customized the',ADMINDOMAIN).' '.PLUGIN_NAME.' '.__('code in any way please abort the update process and backup now.',ADMINDOMAIN).'</p><p><a href="https://codex.wordpress.org/WordPress_Backups">'.__('Click here',ADMINDOMAIN).'</a> '.__('for tips on how to backup your files and database.',ADMINDOMAIN).'</p><a href="'.$download.'"  target="_parent" class="button button-primary">'.__('Update Now',ADMINDOMAIN).'</a>';
			 endif;?>
          </div>
<?php
