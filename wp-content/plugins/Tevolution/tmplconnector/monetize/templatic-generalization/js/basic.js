...
jQuery(function() {
	...
	jQuery('a[data-reveal-id*=tmpl_send_inquiry]').click(function(){
		...
		jQuery('#register_cap').html('');
	});
});
/* Send to friend */
jQuery(function() {
	jQuery('a[data-reveal-id*=tmpl_send_to_frd]').click(function(){
		if(RECAPTCHA_COMMENT == 1)
		{
			captcha = jQuery('#recaptcha_widget_div').html();
			jQuery('#recaptcha_widget_div').html('');
...
jQuery(function() {
	...
	jQuery('a[data-reveal-id*=tmpl_claim_listing]').click(function(){
		if(RECAPTCHA_COMMENT == 1)
		{
			captcha = jQuery('#recaptcha_widget_div').html();
			jQuery('#recaptcha_widget_div').html('');
...
jQuery(function() {
	...
	jQuery('a[data-reveal-id*=tmpl_reg_login_container]').click(function(){
		if(RECAPTCHA_COMMENT == 1)
		{
			captcha = jQuery('#recaptcha_widget_div').html();
			jQuery('#recaptcha_widget_div').html('');
		...
		jQuery('#register_cap').html(captcha);
		jQuery('#recaptcha_widget_div').html('');
		jQuery('#claim_ship_cap').html('');
		jQuery('#myrecap').html('');
		jQuery('#inquiry_frm_popup').html('');
