...
if(is_plugin_active('sitepress-multilingual-cms/sitepress.php')){
	...
	if(strstr($url,'?'))
	{
		$returnUrl = $url."&ptype=return&pmethod=paypal&trans_id=".$trans_id.$suburl;
		$cancel_return = $url."&ptype=cancel&pmethod=paypal&trans_id=".$trans_id;
		$notify_url = $url."&ptype=notifyurl&pmethod=paypal&trans_id=".$trans_id;
	}else
	{ 
		$returnUrl = $url."?ptype=return&pmethod=paypal&trans_id=".$trans_id.$suburl;
		$cancel_return = $url."?ptype=cancel&pmethod=paypal&trans_id=".$trans_id;
