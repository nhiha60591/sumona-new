...
jQuery(document).ready(function() {
	jQuery("#ad_type").change(function() {
		if( "image" == jQuery(this).val() ){
			jQuery(".ad_type_html").hide();
			jQuery(".ad_type_image").show(function(){animate:"normal";});
		}else if( "html" == jQuery(this).val() ){
			jQuery(".ad_type_html").show(function(){animate:"normal";});
			jQuery(".ad_type_image").hide();
		}
	});
});