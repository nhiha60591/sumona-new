...
<div id="content" class="contentarea large-9 small-12 columns <?php //event_class();?>">
	...
	do_action('event_before_categories_title');//do action for display before categories title ?>
	...
	/* Show an optional category description */
	 ...
	 do_action('event_before_loop_taxonomy');?>
      
     <section id="loop_event_taxonomy" class="<?php if(isset($tmpdata['default_page_view']) && $tmpdata['default_page_view']=="gridview"){echo 'grid';}else{echo 'list';}?>" <?php if( is_plugin_active('Tevolution-Directory/directory.php') && isset($tmpdata['default_page_view']) && $tmpdata['default_page_view']=="mapview"){ echo 'style="display: none;"';}?>>
     	<?php if (have_posts()) : 
