...
function supreme_comment_form_args( $args ) {
	...
	$args = array(
		...
		'must_log_in' => '<p class="alert">' . __( 'You must be',THEME_DOMAIN).' <a href="'.$login_url.'" title="'.__('Log in',THEME_DOMAIN).'">'.__('logged in',THEME_DOMAIN).'</a>'.__(' to post a comment.', THEME_DOMAIN ) . '</p><!-- .alert -->',
