 ...
 */
class ListMembershipPackage extends WP_List_Table {
...
$testListTable = new ListMembershipPackage();
...
<div class="wrap">
    ...
    <div class="tevo_sub_title">
        Manage Membership Package <a id="add_membership_package" class="add-new-h2" href="?page=monetization&amp;action=add_membership&amp;tab=membership">Add Membership Package</a>
    </div>
