    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                ...
                <td><input type="text" class="regular-text" id="title" name="title" value="<?php echo @$membership_element['title']; ?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="desc" cols="50" rows="5" id="desc"></textarea><br><p class="description">In a few words, describe what this packages offers.</p>
                </td>
            </tr>
            ...
            <tr class="" id="package_price">
                ...
                <td>
                    <input type="text" name="package_amount" id="package_amount" value="">
